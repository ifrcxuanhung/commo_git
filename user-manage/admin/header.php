	...
	<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
				<p class="navbar-text dropdown-toggle" data-toggle="dropdown" id="userDrop"><?php echo $_SESSION['commo']['gravatar']; ?> <a href="#"><?php echo $_SESSION['commo']['username']; ?></a><b class="caret"></b></p>
				<ul class="dropdown-menu">
		<?php if(in_array(1, $_SESSION['commo']['user_level'])) { ?>
