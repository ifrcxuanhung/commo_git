			...
			<div class="form-group">
			  <button id="create_new_level_btn" class="btn btn-default"><?php _e('Create new level'); ?></button>
				<div class="input-group">
				  ...
				  <input type="number" class="form-control input-mini" min="0" id="showLevels" name="showLevels" placeholder="<?php _e('Show'); ?>" value="<?php echo !empty($_SESSION['commo']['levels_page_limit']) ? $_SESSION['commo']['levels_page_limit'] : 10; ?>">
			  </div>
			</form>
		</div>
