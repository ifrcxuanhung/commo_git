	...
	<div class="col-md-8 pull-right">
		<form method="post" id="search-users-form" action="classes/add_user.class.php" class="form-inline">
			<div class="form-group">
			  ...
			  <input type="number" class="form-control input-mini" min="0" id="showUsers" name="showUsers" placeholder="<?php _e('Show'); ?>" value="<?php echo !empty($_SESSION['commo']['users_page_limit']) ? $_SESSION['commo']['users_page_limit'] : 10; ?>">
			</div>
		</form>
	</div>
