...
class Generic extends Connect {
	...
	public function sendEmail($to, $subj, $msg, $shortcodes = '', $bcc = false) {
		...
		$headers .= 'From: xuanhung1606@gmail.com';
	...
	public function denyAccessLogs() {
		...
		return ( ($this->getOption('profile-timestamps-admin-enable') && !in_array(1, $_SESSION['commo']['user_level'])) || !$this->getOption('profile-timestamps-enable') );
	...
	public function guestOnly() {
		...
		if(!empty($_SESSION['commo']['username'])) {
			$this->error =	"
