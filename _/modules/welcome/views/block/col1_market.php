                ...
                <div class="table-responsive text_scroll scroll-3d" style="height:680px;">
                    <table class="table  table-bordered table-hover table_color table_cus table_fix_padding">
                        ...
                        <tr>
                            ...
                            <th class="th_custom" style="text-align:right" width="8%"> <h6 class="color_h6 cus_type" style="padding:5px !important;">Change</h6> </th>
                            ...
                            <th class="th_custom" style="text-align:left" width="8%"> <h6 class="color_h6 cus_type" style="padding:5px !important;">Time</h6> </th>
