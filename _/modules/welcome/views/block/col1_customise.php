<div class="col-md-7 blocks " style="margin-bottom:30px;">
    ...
    <div class="portlet box blocks cus_hung" style="position:relative;">
        ...
        <div class="portlet-body background_portlet">
            <div class="portlet-body background_portlet" style="margin-top:10px;">
                <div class="table-responsive text_scroll scroller" style="height:294px;">
                    <table class="table  table-bordered table-hover table_color table_cus table_fix_padding">
                        ...
                        <tbody id="dashboard_list_1"><?php echo $d2_box_customise1 ?></tbody>
                    </table>
                </div>
            </div>
        </div>
            ...
            <div class="portlet-body background_portlet" style="margin-top:10px;">
                <div class="table-responsive text_scroll scroller" style="height:294px;">
                    <table class="table  table-bordered table-hover table_color table_cus table_fix_padding">
                        ...
                        <tbody id="dashboard_list_1"><?php echo $d2_box_customise2 ?></tbody>
                    </table>
                </div>
            </div>
        </div>
