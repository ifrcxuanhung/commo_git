...
<?php
if(empty($_SESSION['commo']['token']))
			$_SESSION['commo']['token'] = md5(uniqid(mt_rand(),true));
?>
        ...
        <div class="center-wrap">
            <div class="center-align">
                <div class="center-body">
                    <div class="row" style="margin-left: 0px; margin-right: 0px;">
						...
						foreach($blockstart as $value){
                         ...
                         <div class="col-sm-4 margin-bottom-30 <?php 
									...
									?>">
                            <a href="<?php echo (isset($_SESSION['commo']['username'])) ? $simulation_url.$value['url']: 'javascript:void(0)'; ?>"" class="webapp-btn <?php if(!isset($_SESSION['commo']['username'])) echo "click_show_box";?>"">
                                <?php
                    ...
                    <?php if(!isset($_SESSION['commo']['username'])) {?>
                ...
                <input type="hidden" id="token" name="token" value="<?php if(isset($_SESSION['commo']['token'])) echo $_SESSION['commo']['token']; ?>"/>
                                </div>
