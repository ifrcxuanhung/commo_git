...
ON vcr.dsymbol = A.dsymbol where id_user='".$_SESSION['commo']['user_id']."' ORDER BY datetime desc";
		...
		$sql_2 = "select sql_calc_found_rows sTable.`id`, sTable.`dsymbol`, sTable.`datetime`, sTable.`type`, sTable.`expiry`, sTable.`p`, sTable.`q`, vcr.format
                from (SELECT * FROM excution_traded WHERE user_buy = '".$_SESSION['commo']['user_id']."'or user_sell = '".$_SESSION['commo']['user_id']."') 
