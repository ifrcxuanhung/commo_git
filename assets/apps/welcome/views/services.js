define([
    ...
    var servicesView = Backbone.View.extend({
        ...
        actionBtnEditHelp: function(event){
            ...
            $.ajax({
                url: $base_url + 'services/update_help',
                type: 'POST',
                data: {id:id,des:des},
                cache: false,
                success: function(response) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(rs.status == true) {
                            ...
                            //window.location.reload($base_url+"services/"+category_pa+category_child);

                            window.location.replace($base_url+"services/"+category_pa+category_child);
